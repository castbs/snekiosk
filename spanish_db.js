...
,['botar', 'to throw out, discard']
,['la botella', 'bottle']
,['el brazo', 'arm']
,['breve', 'brief']
,['la broma', 'joke, jest']
,['buen, bueno', 'good, all right']
,['el bulto', 'package, bundle']
,['el buque', 'ship, boat']
,['buscar', 'to look for']
,['el caballero', 'gentleman, sir']
,['caber', 'to fit in, to be room for']
,['la cabeza', 'head']
,['cada', 'each']
,['caer', 'to fall']
...
,['la cama', 'bed']
,['la cámera', 'camera']
,['la camarera', 'chambermaid, waitress']
,['el camarero', 'waiter']
...
,['decir', 'to say, tell']
,['el dedo', 'finger']
,['dejar', 'to let, permit, allow, leave']
...
,['despertar(se)', 'to awaken, wake up']
,['después (de) ', 'after ']
...
,['en', 'in, on, at']
,['enamorado', 'in love']
,['encantado', 'delighted, charmed, pleased to meet you']
,['encender', 'to light, turn on']
,['encima de', 'above, on top of']
,['encontrar', 'to find, meet']
,['enfermo ', 'sick, ill ']
,['enfrente', 'front, opposite, facing']
,['engañar', 'to deceive']
,['enojar', 'to annoy']
...
,['el entremés', 'appetizer, intermission']
,['enviar', 'to send']
,['envolver', 'to wrap']
...
,['el guante', 'glove']
,['guapo', 'handsome']
,['guardia (el/la)', 'guard, police officer']
,['la guerra', 'war']
,['guía (el/la)', 'guidebook']
...
,['regresar', 'to return come back, go back']
,['regular', 'regular, OK']
,['la reina', 'queen']
,['reír(se)', 'to laugh']
